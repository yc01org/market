...
define('DSHOPS_URL','http://www.we10.cn'); // 网站域名
define('DINNERS_URL','http://www.we10.cn'); // 网站域名
define('HTML_PATH','./Application/Runtime/Html/'); //静态缓存文件目录，HTML_PATH可任意设置，此处设为当前项目下新建的html目录
define('QRCODE_PATH','./Public/goodsqrcode'); //生成商品二维码存放地址 
